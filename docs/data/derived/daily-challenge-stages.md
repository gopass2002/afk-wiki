...
하루에 한 번 도는 도전입니다. 시간형 7단계(흑랑의 소굴 3, 심마의 세계 4)와 보스형 100단계(숟가락 할배 습격)로 나뉩니다. 단계마다 어디서 무엇이 나오고 무엇을 받는지 정리했습니다.

경험치는 그 지역 몬스터에 적힌 값입니다. 배포본에 기록이 없는 몬스터는 **기록 없음**으로 두었고, 다른 몬스터나 레벨로 짐작해 채우지 않았습니다.
