...
몬스터 117종의 경험치와 능력치, 나오는 곳, 떨구는 것을 한 자리에 모았습니다.

경험치는 배포본에 적힌 값 그대로입니다. 98종에는 기록이 있고 19종은 기록이 없어 **기록 없음**으로 두었습니다. 떨구는 것은 **후보 목록**이며 처치당 확률이 아닙니다. 한 마리씩 자세히 보려면 [몬스터 낱장]({{ '/docs/몬스터/' | relative_url }})으로 가세요.
